...
export const addAddress = params => { return axios.post(`${base}/addAddress`,params)};

export const delAddress = params => { return axios.get(`${base}/delAddress`,{params:params})};

export const selectAddress = params => { return axios.post(`${base}/selectAddress`,params)};

export const selectOrder = params => { return axios.get(`${base}/selectOrder`,{params:params})};

export const selectUser = params => { return axios.post(`${base}/selectUser`,params)};
